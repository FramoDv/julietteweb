...
import BodyService from "../assets/bodyService.svg";
...
const BodyPage = () => {
    return <>
        <div className={'wrapper service'}>
            <Seo title="Servizi Corpo" description={""}/>
            <div className='container'>
                ...
                <div className="row align-items-start m-120">
                    <div className="col-md-10 col-12">
                        <h2 style={{color: '#a35602'}}>Corpo</h2>
            ...
            <div className="container">
                <div className="row align-items-start mt-120 justify-content-center">
                    ...
                    <div className="col-12  mb-5">
                        <PriceLinear price={70} serviceType={'body'} title={'Russian volume'}/>
                    </div>
                    <div className="col-12 mb-5">
                        <PriceLinear price={85} serviceType={'body'} title={'Multileveling'}/>
                    </div>
                    <div className="col-12  mb-5">
                        <PriceLinear price={35} serviceType={'body'} title={'Ritocco'}/>
                    </div>
                    <div className="col-12  mb-5">
                        <PriceLinear price={50} serviceType={'body'} title={'One to One'}/>
                    </div>
                    <div className="col-12 mb-5">
                        <PriceLinear price={20} serviceType={'body'} title={'Rimozione'}/>
                    </div>
                </div>
            </div>
        </div>
        <NextService serviceType={'makeup'}/>
    </>
}
