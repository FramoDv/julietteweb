...
import MakeUpService from "../assets/makeupService.svg";
            ...
            <div className='container'>
                <div className="row align-items-center">
                    <div className="col-md-6 col-12">
                        <MakeUpService id={'makeup'}/>
                        <h1 className='mt-lg-5 mb-md-0 mt-3 mb-3'>Il meglio per <span style={{color: '#BD2311'}}> il tuo look.</span>
                        </h1>
                    </div>
                    <div className="col-md-6 col-12">
            ...
            <div className="container">
                <div className="row align-items-start mt-120 justify-content-center">
                    ...
                    <div className="col-12  mb-5">
                        <PriceLinear price={70} serviceType={'makeup'} title={'Russian volume'}/>
                    </div>
                    <div className="col-12 mb-5">
                        <PriceLinear price={85} serviceType={'makeup'} title={'Multileveling'}/>
                    </div>
                    <div className="col-12  mb-5">
                        <PriceLinear price={35} serviceType={'makeup'} title={'Ritocco'}/>
                    </div>
                    <div className="col-12  mb-5">
                        <PriceLinear price={50} serviceType={'makeup'} title={'One to One'}/>
                    </div>
                    <div className="col-12 mb-5">
                        <PriceLinear price={20} serviceType={'makeup'} title={'Rimozione'}/>
                    </div>
                </div>
            </div>
        </div>
        <NextService serviceType={'nails'}/>
    </>
}
