...
const Footer = () => {
    ...
    return  <footer>
                ...
                <div className="col-md-6 offset-md-3 col-12">
                    <div className="row justify-content-center d-flex align-items-center mt-4 mb-5">
                        ...
                        <div className="col-12 mt-5 d-flex justify-content-center text-center align-items-center">
                            <p style={{color:"#D56681", fontSize: 14, marginRight: "24px!important"}}>Seguici su</p>
                            <a href={'/services'}>
                                <Instagram/>
                            </a>
                            <a href={'/about'}>
        ...
        <span style={{color:"#D56681"}}>© {new Date().getFullYear()}, Juliette estetica & benessere | P. IVA 93932932939</span>
    </footer>
}
